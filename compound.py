...
class MouseUSVDetector:
    ...
    def visualize_example_detections(self, filepath, data, sample_rate, all_syllables, 
        ...
        for idx, compound in enumerate(examples[:num_examples]):
            ...
            axes[1].set_ylim([max(plot_freq_min, target_khz - zoom_range_plot), min(plot_freq_max, target_khz + zoom_range_plot)]) 
...
if __name__ == "__main__":
    ...
    print("="*70)
#coded these print statements to show transparency during execution process 
